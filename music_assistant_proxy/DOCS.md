This addon creates a proxy to a Music Assistant server run separately from Home Assistant so that you can have the benefit of access in the sidebar without running Music Assistant as an addon.<br>
<br>
